...
import classes from "./MintMain.module.css";
      ...
      <Container className="z-20">
        <Row>
          <Col xs={12} className="text-center">
            <div className={`${classes.icoHeading} z-12`}>
              <h1>
                <a href="#">Minting</a> SOON
              </h1>
            </div>
          </Col>
        </Row>
        ...
        <Row>
          {candyMachine && (
            <Col xs={12}>
              <div className={classes.customProgressBar}>
                ...
                <ProgressBar
                  now={
                    ((candyMachine.state.itemsAvailable - itemsRemaining!) /
                ...
                >
                  <p>
                    {candyMachine.state.itemsAvailable - itemsRemaining!} NFTs
                  </p>
                  <div className={classes.progressDTop}></div>
                </div>
                {/* </div> */}
              </div>
              <Row>
                <Col xs={6}>
                  <div className={classes.singleCup}>
                    <p>Start</p>
                  </div>
                </Col>
                <Col xs={6} className="text-right">
                  <div
                    className={`${classes.singleCup} ${classes.singleCupRight}`}
                  >
                    <p>End</p>
                  </div>
                </Col>
          ...
          <Col xs={12} className="text-center z-40">
